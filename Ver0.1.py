...
class HUPU_Model():
    ...
    def analyse_page(self):
        ...
        self.bsObj=BeautifulSoup(htmlcontent,'lxml',from_encoding='utf-8')
    ...
    def get_num_threads(self):
        all_threads_tags=self.bsObj.find_all(lambda tag: tag.name=='a' and tag.get('id')=="" and len(tag.attrs)==2)
        num_threads=len(all_threads_tags)
        return num_threads
